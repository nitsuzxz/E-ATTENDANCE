...
if (isset($_GET['edit'])){
    ...
    if(isset($_POST['kpengajar'])){
        ...
        $mysqli_query  = mysqli_query($connection, "UPDATE pengajar SET nama_pengajar='$nama', email_pengajar='$email',bahagian='$bahagian',jawatan='$jawatan' WHERE id_pengajar=$id_pengajar");
