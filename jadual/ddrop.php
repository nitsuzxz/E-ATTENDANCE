...
if (isset($_GET['slot'])) {
        ...
        if($st== "JUMAAT"){  
                ...
                echo"<div id='jst' class='form-check-inline form-check'>";
                        ...
                        echo"<input type='checkbox'  value='option1' class='form-check-input' >";
                            echo"Slot 1";
                        echo"</label>";
                        echo"<label  class='form-check-label'>";
                            echo"<input type='checkbox'  value='2' class='form-check-input' >";
                            echo"Slot 2";
                        echo"</label>";
                        echo"<label class='form-check-label'>";
                            echo" <input type='checkbox'  value='3' class='form-check-input' >";
                            echo"Slot 3";
                            echo"</label>";
                         echo" <label  class='form-check-label'>";
                        echo"<input type='checkbox'  value='4' class='form-check-input' >";
                            echo"Slot 4";
                        echo"</label>";
                        echo"<label  class='form-check-label'>";
                            echo"<input type='checkbox'  value='5' class='form-check-input' >";
                            echo"Slot 5";
                        echo"</label>";
             echo" </div> ";
               ...
               echo"<div id='jst' class='form-check-inline form-check'>";
                        echo" <label  class='form-check-label'>";
                        echo"<input type='checkbox'  value='option1' class='form-check-input' disabled>";
                            echo"Slot 1";
                        echo"</label>";
                        echo"<label  class='form-check-label'>";
                            echo"<input type='checkbox'  value='2' class='form-check-input' disabled>";
                            echo"Slot 2";
                        echo"</label>";
                        echo"<label class='form-check-label'>";
                            echo" <input type='checkbox'  value='3' class='form-check-input' disabled>";
                            echo"Slot 3";
                            echo"</label>";
                         echo" <label  class='form-check-label'>";
                        echo"<input type='checkbox'  value='4' class='form-check-input' disabled>";
                            echo"Slot 4";
                        echo"</label>";
                        echo"<label  class='form-check-label'>";
                            echo"<input type='checkbox'  value='5' class='form-check-input' disabled>";
                            echo"Slot 5";
                        echo"</label>";
                        echo"<label class='form-check-label'>";
                            echo" <input type='checkbox'  value='6' class='form-check-input' disabled>";
                            echo"Slot 6";
                            echo"</label>";        
                              echo"</div>";
             echo" </div> ";
